 ...
 * DAG (`p4nexus/src/core/ingestion/` outside `scope-resolution/`) and
 * the scope-resolution pipeline (`p4nexus/src/core/ingestion/scope-resolution/`).
 ...
 * `ScopeResolver` contract (`p4nexus/src/core/ingestion/scope-resolution/contract/scope-resolver.ts`)
