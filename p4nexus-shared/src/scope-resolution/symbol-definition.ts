 ...
 *
 * Historically defined in `p4nexus/src/core/ingestion/model/symbol-table.ts`;
 * moved into `p4nexus-shared` as part of RFC #909 Ring 1 (#910) so the
 * scope-resolution types that reference it can live in the shared package
 * alongside their consumers (`p4nexus/` and `p4nexus-web/`).
 *
