...
import { getDefaultP4nexusDir, getGroupDir, listGroups, readContractRegistry } from './storage.js';
...
export class GroupService {
  ...
  async groupImpact(params: Record<string, unknown>): Promise<unknown> {
    ...
    return runGroupImpact({ port: this.port, p4nexusDir: getDefaultP4nexusDir() }, params);
  }
