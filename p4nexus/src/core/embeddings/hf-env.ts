 ...
 * public package API.
 *
 * Minimal subset of `@huggingface/transformers`' `env` object that p4nexus
 ...
 * bridges so every p4nexus embedder entry point (the analyze pipeline
 ...
 *   its own install dir, which is unwritable when p4nexus is installed
