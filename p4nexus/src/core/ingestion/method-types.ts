// p4nexus/src/core/ingestion/method-types.ts

import type { SupportedLanguages } from 'p4nexus-shared';
...
export interface MethodExtractor {
  ...
  extractFunctionName?(
    node: SyntaxNode,
  ): { funcName: string | null; label: import('p4nexus-shared').NodeLabel } | null;
}
