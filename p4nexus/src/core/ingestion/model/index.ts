...
// `SymbolDefinition` moved to `p4nexus-shared` (RFC #909 Ring 1 #910).
// Consumers should import it directly from `p4nexus-shared`, not via this barrel.
...
// `MroStrategy` itself lives in `p4nexus-shared`; re-exported here for
