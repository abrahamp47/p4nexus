 ...
 *
 * Strategy summary (full docs in p4nexus-shared/mro-strategy.ts):
 ...
 *
 * @see p4nexus-shared/mro-strategy.ts § 'ruby-mixin'
...
export const lookupMethodByOwnerWithMRO = (
  ...
  // See p4nexus-shared/mro-strategy.ts § 'ruby-mixin' for full strategy docs.
