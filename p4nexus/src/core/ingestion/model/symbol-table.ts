 ...
 *
 *     p4nexus-shared (NodeLabel)       — leaf type
 *          ↑
...
import type { NodeLabel, SymbolDefinition } from 'p4nexus-shared';
...
// `SymbolDefinition` moved to `p4nexus-shared` as part of RFC #909 Ring 1
// (see #910). It is imported at the top of this file from `p4nexus-shared`
// and re-used unchanged throughout. Consumers should import
// `SymbolDefinition` directly from `p4nexus-shared`, not via this file.
