 ...
 *      `p4nexus/src/core/ingestion/languages/<lang>/scope-resolver.ts`.
 ...
 *      `p4nexus/src/core/ingestion/scope-resolution/pipeline/registry.ts`
 ...
 *      `p4nexus/test/integration/resolvers/<lang>.test.ts` passes
 ...
 *
 * `p4nexus/src/core/ingestion/languages/python/scope-resolver.ts` —
 ...
 * ## Semantic-model source of truth
 *
 * `ParsedFile` (from `p4nexus-shared/src/scope-resolution/parsed-file.ts`)
 ...
 *     `p4nexus/src/core/ingestion/call-processor.ts` for the legacy
