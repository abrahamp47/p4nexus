## P4Nexus vendor notice

This directory is a P4Nexus-managed vendored copy of the official
`tree-sitter-swift@0.7.1` npm runtime package, including its official native
prebuilds. P4Nexus keeps the top-level `tree-sitter` dependency pinned to
...
P4Nexus tarball can load `tree-sitter-swift`.
