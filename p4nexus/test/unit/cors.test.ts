 ...
 *   - https://p4nexus.vercel.app     → allowed
...
describe('isAllowedOrigin: vercel.app', () => {
  it('allows https://p4nexus.vercel.app', () => {
    expect(isAllowedOrigin('https://p4nexus.vercel.app')).toBe(true);
  });
...
describe('isAllowedOrigin: rejected origins', () => {
  ...
  it('rejects https://p4nexus.example.com (not the official domain)', () => {
    expect(isAllowedOrigin('https://p4nexus.example.com')).toBe(false);
  });
