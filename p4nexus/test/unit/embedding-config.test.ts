...
describe('resolveEmbeddingConfig', () => {
  it('applies env overrides for local resource controls', () => {
    process.env.P4NEXUS_EMBEDDING_THREADS = '3';
    process.env.P4NEXUS_EMBEDDING_BATCH_SIZE = '7';
    process.env.P4NEXUS_EMBEDDING_SUB_BATCH_SIZE = '5';
    process.env.P4NEXUS_EMBEDDING_DEVICE = 'cpu';
  ...
  it('rejects invalid numeric env values', () => {
    process.env.P4NEXUS_EMBEDDING_THREADS = '0';

    expect(() => resolveEmbeddingConfig()).toThrow('P4NEXUS_EMBEDDING_THREADS');
  });
});
